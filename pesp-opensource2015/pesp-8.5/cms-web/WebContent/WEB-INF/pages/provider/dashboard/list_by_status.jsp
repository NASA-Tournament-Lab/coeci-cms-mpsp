                ...
                <div class="contentWidth">
                    ...
                    <div class="tabSection">
                        ...
                        <div class="tabHead">
                            <div class="tabR">
                                <div class="tabM">
                                    <a class="tab ${statusFilter eq 'Draft' ? 'active' : ''}" href="<c:url value="/provider/dashboard/drafts" />"><span class="aR"><span class="aM">Draft</span></span></a>
                        ...
                        <div class="tabContent" id="tabDraft">
                            ...
                            <div class="pagination">
                                ...
                                <div class="right">
                                    ...
                                    <a href="javascript:submitFormById('paginationForm','${exportResultsURL}')" class="greyBtn"><span class="btR"><span class="btM"><img src="<c:url value="/i/icon-pdf.png" />" alt=""/>Export to PDF</span></span></a>
                                </div>
                            </div>
                            <!-- /.pagination -->
