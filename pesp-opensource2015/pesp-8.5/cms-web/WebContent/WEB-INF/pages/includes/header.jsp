...
<div id="header">
    <div class="contentWidth">
        <div class="userSection">
            Welcome, <strong><sec:authentication property="principal.username" /></strong> | <a href="/cms/admin/searchHelp">Help</a> | <a href="<spring:url value="/j_spring_security_logout" />">Logout</a>
        </div>
        <!-- /.userSection -->
        <div class="mastHead">
