...
/**
 * This class provides the web service implementation of the CommunityMentalHealthCenterLicensingService interface.
 * 
 * @author cyberjag
 * @version 1.0
 */
@WebService
public class CommunityMentalHealthCenterLicensingServiceImpl extends AbstractBaseService implements
        CommunityMentalHealthCenterLicensingService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = CommunityMentalHealthCenterLicensingServiceImpl.class.getName();
     ...
     * Empty constructor
     */
    public CommunityMentalHealthCenterLicensingServiceImpl() {
    }
    ...
    protected void init() {
        ...
        try {
            ...
            communityMentalHealthCenterLicensingDAO = (CommunityMentalHealthCenterLicensingDAO) ctx
                    .lookup("cms-external-sources/CommunityMentalHealthCenterLicensingDAOBean/local");
