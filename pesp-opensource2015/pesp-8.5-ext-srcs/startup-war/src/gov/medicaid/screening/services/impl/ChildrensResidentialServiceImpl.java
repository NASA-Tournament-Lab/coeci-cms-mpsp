...
/**
 * This class provides the web service implementation of the ChildrensResidentialService interface.
 * 
 * @author cyberjag
 * @version 1.0
 */
@WebService
public class ChildrensResidentialServiceImpl extends AbstractBaseService implements ChildrensResidentialService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = ChildrensResidentialServiceImpl.class.getName();
     ...
     * Empty constructor
     */
    public ChildrensResidentialServiceImpl() {
    }
    ...
    protected void init() {
        ...
        try {
            ...
            childrensResidentialDAO = (ChildrensResidentialDAO) ctx
                    .lookup("cms-external-sources/ChildrensResidentialDAOBean/local");
