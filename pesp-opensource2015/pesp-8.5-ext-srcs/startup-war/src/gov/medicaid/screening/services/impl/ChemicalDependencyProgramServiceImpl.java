...
/**
 * This class provides a web service implementation of the ChemicalDependencyProgramService interface.
 * 
 * @author cyberjag
 * @version 1.0
 */
@WebService
public class ChemicalDependencyProgramServiceImpl extends AbstractBaseService implements ChemicalDependencyProgramService {
    /**
     * Represent the name of this class
     */
    private static final String CLASS_NAME = ChemicalDependencyProgramServiceImpl.class.getName();
     ...
     * Empty constructor
     */
    public ChemicalDependencyProgramServiceImpl() {
    }
    ...
    protected void init() {
        ...
        try {
            ...
            chemicalDependencyProgramDAO = (ChemicalDependencyProgramDAO) ctx
                    .lookup("cms-external-sources/ChemicalDependencyProgramDAOBean/local");
     ...
     */
    @WebMethod
    public SearchResult<ProviderProfile> search(ChemicalDependencyProgramSearchCriteria criteria)
            throws ServiceException {
